...
#    Updated: 2018/02/06 14:19:41 by msicot           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME = ft_printf.c ft_flags.c	ft_format.c	ft_integer.c	ft_is_type.c	ft_itoa_max.c	ft_options.c	ft_printf.c	ft_read.c\
	   	   ft_is_num.c ft_is_c.c ft_is_p.c	ft_is_unic.c ft_string.c ft_octal.c ft_octal2.c	ft_itoa_base.c	ft_width.c ft_sign.c \
